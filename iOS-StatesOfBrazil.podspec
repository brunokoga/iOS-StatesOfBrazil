#
#  Be sure to run `pod spec lint iOS-StatesOfBrazil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/iOS-StatesOfBrazi://github.com/chrisfsampaio/iOS-StatesOfBrazil"
  ...
  # s.authors          = { "Christian Sampaio" => "christian.fsampaio@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'Christian Sampaio', 'other author'
  # s.social_media_url = "http://twitter.com/Christian Sampaio"
